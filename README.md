 ...
 **좋아요 기능 동시성 문제 해결 및 Redis 도입을 통한 성능 개선  / nGrinder 기반 성능 검증** <br /> <br />
...
<br />
성능 검증을 위해 **nGrinder**로 300명의 가상 사용자를 생성해 동시에 조회 API를 호출하는 부하 테스트를 수행했습니다.
<br /><br />
