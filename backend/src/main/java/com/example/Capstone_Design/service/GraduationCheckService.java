...
public class GraduationCheckService {
    ...
    // 필수과목 자가진단
    public List<GraduationCheckResponse> getSubjectCheckList(List<GraduationCheckDTO> allList,
            List<GraduationCheckDTO> checkList, String studentNumber, String majorCode) {
    ...
    public List<GraduationCheckDTO> graduationCheck(String studentNumber, String majorCode) {
        ...
        List<GraduationCheckDTO> graduationCheckDTO = studentSubjectRepository.graduationCheck(studentNumber,
                majorCode);
    ...
    public String getMajorCode(String major) {
        ...
        MajorEntity majorEntity = majorRepository.findByMajor(major)
                .orElseThrow(() -> new MajorCodeNotFoundException("입력하신 학과에 대한 학과코드가 존재하지 않습니다."));
    ...
    public boolean studentSubjectSave(String studentNumber, List<String> subjectNames, UserDTO user) {
         ...
         * "graduation:check:result:" + studentNumber + ":" + majorCode + ":" +
         * scdMajorCode
         * );
         * 
         ...
         * 
         * studentSubjectRepository.deleteById(new StudentSubjectId(studentNumber,
         * subjectName));
         * }
         * }
         * 
         ...
         * StudentSubjectEntity studentSubjectEntity = new
         * StudentSubjectEntity(studentSubjectId, subjectMap.get(subject));
         * 
         ...
         * StudentSubjectEntity studentSubjectEntity = new StudentSubjectEntity(new
         * StudentSubjectId(studentNumber, subjectName), new SubjectEntity());
         * 
